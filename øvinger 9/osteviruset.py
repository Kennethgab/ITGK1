...
for cheesename, cheese in cheeses.items():
    for row in cheese:
        prefix = row.split("-")[0]
        if prefix in ('A234','A235','B13','B14','B15','C31'):
            print(row, cheesename, "INFISERT OST!")

print()
print(("Ikke infisert ost:"))
print()

for cheesename,cheese in cheeses.items():
    for row in cheese:
        prefix = row.split("-")[0]
        if prefix not in('A234','A235','B13','B14','B15','C31'):
            print(row, cheesename)
